        ...
        <?php include 'partials/menu.php'; ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Morvin', 'subtitle' =>'Ecommerce' , 'title' => 'Checkout')); ?>
                                                        ...
                                                        <table class="table table-centered mb-0 table-nowrap">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail.php" class="text-reset">Home & Office Chair Green</a></h5>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-centered mb-0 table-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail.php" class="text-reset">Home & Office Chair Cream</a></h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail.php" class="text-reset">Home & Office Chair Black</a></h5>
