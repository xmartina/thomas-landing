...
<?php include 'partials/main.php'; ?>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Knob Charts')); ?>
    ...
    <body>
        ...
        <?php include 'partials/menu.php'; ?>
            ...
            <div class="main-content">
                ...
                <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Morvin', 'subtitle' =>'Charts' , 'title' => 'Knob Charts')); ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center" dir="ltr">
                                                <input data-plugin="knob" data-width="180" data-height="180" data-min="-15000"
                                                    data-displayPrevious=true data-max="15000" data-step="1000" value="11000" data-thickness=".12"
                                                    data-fgColor="#7c8a96" />
                                            </div>
                                        </div> <!-- end card-body-->
                                    </div> <!-- end card-->
