...
<?php include 'partials/main.php'; ?>
    <head>
        ...
        <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Comingsoon')); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            <a href="index.php" class="logo"><img src="assets/images/logo-dark.png" height="24" alt="logo"></a>
