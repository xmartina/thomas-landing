        ...
        <?php include 'partials/menu.php'; ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Morvin', 'subtitle' =>'Ecommerce' , 'title' => 'Cart')); ?>
                                                ...
                                                <table class="table table-centered mb-0 table-nowrap">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail.php" class="text-reset">Home & Office Chair</a></h5>
