...
<?php include 'partials/main.php'; ?>
    <head>
        ...
        <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Sweet Alerts')); ?>
        ...
        <?php include 'partials/menu.php'; ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Morvin', 'subtitle' =>'UI Elements' , 'title' => 'Sweet Alerts')); ?>
