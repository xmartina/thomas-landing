...
<?php include 'partials/main.php'; ?>
    <head>
        ...
        <?php includeFileWithVariables('partials/title-meta.php', array('title' => '404 Page')); ?>
                            ...
                            <div class="card-body">
                                <div class="px-2 py-3">
                                    ...
                                    <div class="text-center p-3">
                                        ...
                                        <a class="btn btn-primary waves-effect waves-light" href="index.php"><i class="mdi mdi-home"></i> Back to Dashboard</a>
                                    </div>
