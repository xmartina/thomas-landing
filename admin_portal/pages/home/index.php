        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <?php include_once __DIR__.'/../../partials/action_alert_template.php'?>
                    <div class="card-body">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <img class="rounded mt-2" src="/assets/school_image/staff/<?=$rec_img?>" alt="" style="max-height:45px;">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="col-lg-5">
                                                <img class="rounded mt-2" src="/assets/images/<?=$extra_img?>" alt="" style="max-height:45px;">
                                            </div>
                                        </div>
                                        <!-- Submit Button -->
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
