        ...
        <div class="service-grid mb-40 wow fadeInUpSmall" data-wow-delay=".3s">
            ...
            <div class="icon-box1-visible flex-two">
                <div class="content">
                    ...
                    <h3 class="title mb-47"><a href="department?book_id=' . $row['book_id'] . '">' . htmlspecialchars($row['dep_name']) . '</a></h3>
                    <div class="icon">
                        <i class="icon-Icon11"></i>
                    </div>
                </div>
                <div class="button-icon-box">
                    <a href="department?book_id=' . $row['book_id'] . '" class="service-link"><i class="icon-angle-downs"></i></a>
                </div>
            </div>
            <div class="icon-box1-hide">
                ...
                <h3 class="title"><a href="department?book_id=' . $row['book_id'] . '">' . htmlspecialchars($row['dep_name']) . '</a></h3>
                <p class="des">' . htmlspecialchars($row['dep_short_dec']) . '</p>
                <div class="button-icon-box">
                    <a href="department?book_id=' . $row['book_id'] . '" class="service-link">Read More<i class="icon-right-icon"></i></a>
                </div>
            </div>
        </div>';
                    $i++; // Increment counter
