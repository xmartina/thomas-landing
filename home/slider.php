                    ...
                    <div class="tf-container">
                        <div class="slider-content-it relative z-index-3">
                            ...
                            <h1 class="title-slider text-white wow fadeInUpSmall" data-wow-delay=".2s">
                                <?php
                                // Function to add <br> after approximately every 18 characters, breaking at spaces
                                function addBreaks($text, $maxLength = 18) {
                                    // Use regular expression to insert <br> at nearest space after every 18 characters
